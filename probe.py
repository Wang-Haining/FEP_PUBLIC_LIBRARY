...
def probe(df, max_features=110, model_name=None):
    """
    ...
    Parameters:
        ...
        - max_features: number of top TF-IDF features to use (fixed at 110)
...
def main():
    ...
    if args.debug:
        ...
        results = probe(df, max_features=110, model_name=model)
